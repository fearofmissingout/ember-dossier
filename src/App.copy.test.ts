...
describe("hosted playtest copy", () => {
  ...
  test("keeps the expedition flow as a mobile-friendly single-page command center", () => {
    ...
    expect(source.indexOf("<JourneyPanel")).toBeGreaterThan(-1);
    expect(source.indexOf("<JourneyPanel")).toBeLessThan(source.indexOf("id=\"prep-squad\""));
    expect(source).toContain("expedition-layout journey-active");
    ...
    expect(source).toContain("mobileSecondaryActions");
    expect(source).toContain("aria-label=\"手机端当前行动\"");
    expect(source).toContain("aria-label=\"手机端备选行动\"");
    expect(source).toContain("journey-mobile-command-actions");
    expect(source).toContain("journey-mobile-secondary-actions");
    expect(source).toContain("看状态");
    ...
    expect(styles).toContain(".journey-mobile-secondary-actions");
    expect(styles).toContain(".journey-mobile-command-links");
    expect(styles).toContain(".journey-command-center > .journey-command-hud");
    expect(styles).toContain(".journey-command-center > .journey-action-guide");
    expect(styles).toContain(".journey-command-center > .journey-action-comparison");
    expect(styles).toContain(".journey-command-center > .journey-result-breakdown");
    expect(styles).toContain(".expedition-layout.journey-active > .expedition-prep-command");
    expect(styles).toContain(".journey-mobile-command-card {\n    order: 1;");
    expect(styles).toContain(".journey-mobile-flow {\n    order: 2;");
    expect(styles).toContain(".journey-section-nav {\n    order: 3;");
    expect(styles).toContain(".side-rail .room-card");
    expect(styles).toContain(".side-rail .playtest-settings-card");
    expect(styles).toContain(".journey-section-nav");
  ...
  test("keeps mobile navigation as an in-app bottom bar instead of page hops", () => {
    ...
    expect(source).toContain("aria-label=\"手机端状态栏\"");
    expect(source).toContain("activeViewLabel");
    expect(source).toContain("mobile-command-room");
    expect(source).toContain("mobile-command-view");
    expect(source).toContain("mobile-command-metrics");
    ...
    expect(styles).toContain(".mobile-command-view");
    expect(styles).toContain(".mobile-command-metrics");
